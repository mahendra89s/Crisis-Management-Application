                    ...
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.NewsClickedEvent);
                        },
                      ),
                      MenuItem(
                        title: 'languages'.tr(),
                      ...
                      MenuItem(
                        title: 'government_scheme'.tr(),
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(
                              NavigationEvents.GovernmentSchemesClickedEvent);
                        },
                      ),
                      MenuItem(
                        title: "instruction_manual".tr(),
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(
